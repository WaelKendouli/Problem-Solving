...
bool isPeriodsAreOverlaped(stPeriod Period1, stDate Date)
{
	if (CompareDatesInGeneral(Date, Period1.StartDate) == enDateStatus::Before
...
int main()
{
	...
	Date = ReadDate();
	if (IsDateInRange(Period,Date)==true)
	{
