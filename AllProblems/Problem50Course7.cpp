...
bool MarkClientForDelete(string AccountNumber, vector<sClient>& vClientData)
{
    for (sClient& Line : vClientData)
    {
...
bool DeleteClientFromFile(string AccountNumber , vector<sClient>& vClientData)
{
    sClient Client;
    char UserChoice = 'n';
    if (FindClientAccount(AccountNumber , vClientData, Client) == true)
    {
        ...
        {
            MarkClientForDelete(AccountNumber, vClientData);
            SaveClientsDataToFile(fileName, vClientData);
            //refresh clients
            vClientData = LoadClientDataFromFile(fileName);
            cout << "Your record has been deleted succesfuly";
            return true;
        }
    }
    else
...
int main()
{
    ...
    DeleteClientFromFile(AccountNumber, vClientData);
